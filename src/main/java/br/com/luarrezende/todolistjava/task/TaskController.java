package br.com.luarrezende.todolistjava.task;
...
import br.com.luarrezende.todolistjava.utils.Utils;
...
public class TaskController {
  ...
  public ResponseEntity<Object> create(@RequestBody TaskModel taskModel, HttpServletRequest request) {
    ...
    if(currentDate.isAfter(taskModel.getStartAt()) || currentDate.isAfter(taskModel.getEndAt())) {
      return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("a data inicial / data final deve ser maior que a atual");
    };
